...
DATABASES = {
    'default': dj_database_url.config(default='postgresql://root:brXWTnxt4n8nG6Q90IDGKjtnO1bvrIml@dpg-d4nnf449c44c73d1adbg-a/votoautomatizadodb_gguh', conn_max_age=600)
}
